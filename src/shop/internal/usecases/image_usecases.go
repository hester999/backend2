...
type ImageRepo interface {
	AddImage(productId string, image entity.Image) (entity.Image, error)
...
func (i *Image) AddImage(productId string, img []byte) (entity.Image, error) {
	...
	newImg, err = i.img.AddImage(productId, newImg)
	if err != nil {
